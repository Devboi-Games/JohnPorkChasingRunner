...
void main()
{
    ...
    u_xlat1.xyz = _WorldSpaceLightPos0.xyz * u_xlat16_2.xxx + u_xlat0.xyz;
    ...
    u_xlat4 = u_xlat4 * _SelfShadowColor.w;
    u_xlat1.xyz = _Diffuse.xyz * _SelfShadowColor.xyz + (-_Diffuse.xyz);
    u_xlat1.xyz = vec3(u_xlat4) * u_xlat1.xyz + _Diffuse.xyz;
    u_xlat1.w = 1.0;
    u_xlat1 = vec4(u_xlat12) * _SpecularColor + u_xlat1;
...
void main()
{
    ...
    u_xlat2.xyz = _WorldSpaceLightPos0.xyz * u_xlat16_3.xxx + u_xlat1.xyz;
    ...
    u_xlat6 = u_xlat6 * _SelfShadowColor.w;
    u_xlat2.xyz = _Diffuse.xyz * _SelfShadowColor.xyz + (-_Diffuse.xyz);
    u_xlat2.xyz = vec3(u_xlat6) * u_xlat2.xyz + _Diffuse.xyz;
    u_xlat2.w = 1.0;
    u_xlat2 = vec4(u_xlat16) * _SpecularColor + u_xlat2;
...
void main()
{
    ...
    u_xlat0 = (-u_xlat0) + 1.0;
    u_xlat0 = u_xlat0 * _Falloff;
    u_xlat0 = log2(u_xlat0);
    u_xlat0 = u_xlat0 * _FalloffPower;
    u_xlat0 = exp2(u_xlat0);
    u_xlat16_3.x = dot(_WorldSpaceLightPos0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_3.x = inversesqrt(u_xlat16_3.x);
    u_xlat4.xyz = _WorldSpaceLightPos0.xyz * u_xlat16_3.xxx + u_xlat4.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xxx * _WorldSpaceLightPos0.xyz;
    u_xlat13 = dot(u_xlat1.xyz, u_xlat16_3.xyz);
    u_xlat13 = (-u_xlat13) + 1.0;
    u_xlat13 = u_xlat13 * _SelfShadowColor.w;
    ...
    u_xlat1.xyz = _Diffuse.xyz * _SelfShadowColor.xyz + (-_Diffuse.xyz);
    u_xlat1.xyz = vec3(u_xlat13) * u_xlat1.xyz + _Diffuse.xyz;
    u_xlat1.w = 1.0;
    u_xlat1 = u_xlat4.xxxx * _SpecularColor + u_xlat1;
    u_xlat2 = (-u_xlat1) + _FalloffColor;
    vs_COLOR0 = vec4(u_xlat0) * u_xlat2 + u_xlat1;
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    return;
}
...
void main()
{
    ...
    u_xlat5.xyz = _WorldSpaceLightPos0.xyz * u_xlat16_4.xxx + u_xlat5.xyz;
    u_xlat16_4.xyz = u_xlat16_4.xxx * _WorldSpaceLightPos0.xyz;
    u_xlat17 = dot(u_xlat2.xyz, u_xlat16_4.xyz);
    u_xlat17 = (-u_xlat17) + 1.0;
    u_xlat17 = u_xlat17 * _SelfShadowColor.w;
    ...
    u_xlat2.xyz = _Diffuse.xyz * _SelfShadowColor.xyz + (-_Diffuse.xyz);
    u_xlat2.xyz = vec3(u_xlat17) * u_xlat2.xyz + _Diffuse.xyz;
    u_xlat2.w = 1.0;
    u_xlat2 = u_xlat5.xxxx * _SpecularColor + u_xlat2;
    u_xlat3 = (-u_xlat2) + _FalloffColor;
    vs_COLOR0 = u_xlat0.xxxx * u_xlat3 + u_xlat2;
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    ...
    vs_TEXCOORD1 = hlslcc_mtx4x4unity_WorldToShadow[3] * u_xlat1.wwww + u_xlat0;
    return;
}
...
void main()
{
    ...
    gl_Position = u_xlat2;
    vs_TEXCOORD2 = u_xlat2.z * unity_FogParams.z + unity_FogParams.w;
    u_xlat5.xyz = in_POSITION0.yyy * unity_Builtins0Array[u_xlati0 / 8].hlslcc_mtx4x4unity_ObjectToWorldArray[1].xyz;
    u_xlat5.xyz = unity_Builtins0Array[u_xlati0 / 8].hlslcc_mtx4x4unity_ObjectToWorldArray[0].xyz * in_POSITION0.xxx + u_xlat5.xyz;
    u_xlat5.xyz = unity_Builtins0Array[u_xlati0 / 8].hlslcc_mtx4x4unity_ObjectToWorldArray[2].xyz * in_POSITION0.zzz + u_xlat5.xyz;
    u_xlat5.xyz = unity_Builtins0Array[u_xlati0 / 8].hlslcc_mtx4x4unity_ObjectToWorldArray[3].xyz * in_POSITION0.www + u_xlat5.xyz;
