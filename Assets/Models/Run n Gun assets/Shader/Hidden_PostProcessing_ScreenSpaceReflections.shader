...
void main()
{
    ...
    u_xlat2 = min(u_xlat16_0, u_xlat16_1);
    u_xlat0 = max(u_xlat16_0, u_xlat16_1);
    ...
    u_xlat3.x = dot(u_xlat16_3.xy, u_xlat16_3.xy);
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat2.xyz = u_xlat16_4.xyz * u_xlat16_3.xyz + (-u_xlat16_6.xyz);
    u_xlat0.xyz = u_xlat0.xxx * u_xlat2.xyz + u_xlat16_6.xyz;
    SV_Target0.xyz = u_xlat0.xyz * vec3(u_xlat1) + u_xlat7.xyz;
