...
void main()
{
    ...
    u_xlat1.xyz = u_xlat10_1.xyz * vec3(3.55539989, 3.55539989, 0.0) + vec3(-1.77769995, -1.77769995, 1.0);
    ...
    for(int u_xlati_loop_1 = int(0) ; u_xlati_loop_1<3 ; u_xlati_loop_1++)
    {
        ...
        u_xlat5.y = vs_TEXCOORD0.x * 1.00000001e-10 + u_xlat1.x;
        ...
        u_xlat1.x = u_xlat1.x * _AOParams.y;
        u_xlat14.xyz = u_xlat1.xxx * u_xlat6.xyz;
        ...
        u_xlat1.x = (-u_xlat14.z) + 1.0;
        u_xlat1.x = unity_OrthoParams.w * u_xlat1.x + u_xlat14.z;
        ...
        u_xlat1.x = texture2DLodEXT(_CameraDepthTexture, u_xlat14.xy, 0.0).x;
        u_xlat1.x = u_xlat1.x * _ZBufferParams.x;
        u_xlat29 = (-unity_OrthoParams.w) * u_xlat1.x + 1.0;
        u_xlat1.x = u_xlat9 * u_xlat1.x + _ZBufferParams.y;
        ...
        u_xlatb30 = 9.99999975e-06>=u_xlat1.x;
        u_xlat30 = u_xlatb30 ? 1.0 : float(0.0);
        u_xlat29 = u_xlat29 + u_xlat30;
        u_xlat29 = u_xlat29 * 100000000.0;
        u_xlat6.z = u_xlat1.x * _ProjectionParams.z + u_xlat29;
        u_xlat22.xy = u_xlat22.xy + (-hlslcc_mtx4x4unity_CameraProjection[2].xy);
        u_xlat22.xy = u_xlat22.xy + vec2(-1.0, -1.0);
        u_xlat22.xy = u_xlat22.xy / u_xlat4.xy;
        u_xlat1.x = (-u_xlat6.z) + 1.0;
        u_xlat1.x = unity_OrthoParams.w * u_xlat1.x + u_xlat6.z;
        u_xlat6.xy = u_xlat1.xx * u_xlat22.xy;
        u_xlat14.xyz = (-u_xlat3.xyz) + u_xlat6.xyz;
        u_xlat1.x = dot(u_xlat14.xyz, u_xlat2.xyz);
        u_xlat1.x = (-u_xlat3.z) * 0.00200000009 + u_xlat1.x;
...
void main()
{
    ...
    u_xlat7.xyz = u_xlat10_2.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat10_3.xyz = texture2D(_CameraDepthNormalsTexture, vs_TEXCOORD1.xy).xyz;
    u_xlat3.xyz = u_xlat10_3.xyz * vec3(3.55539989, 3.55539989, 0.0) + vec3(-1.77769995, -1.77769995, 1.0);
    ...
    u_xlat2 = u_xlat7.x * u_xlat10_2.x;
    ...
    u_xlat9.xyz = u_xlat10_4.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    ...
    u_xlat6.xyz = u_xlat10_1.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    ...
    u_xlat5.xyz = u_xlat10_0.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
...
void main()
{
    ...
    u_xlat3.xyz = u_xlat16_3.xyz * vec3(3.55539989, 3.55539989, 0.0) + vec3(-1.77769995, -1.77769995, 1.0);
    u_xlat13 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat13 = 2.0 / u_xlat13;
    u_xlat9.xy = u_xlat3.xy * vec2(u_xlat13);
    u_xlat9.z = u_xlat13 + -1.0;
    ...
    u_xlat7.x = u_xlat7.x * u_xlat12;
    u_xlat7.x = u_xlat7.x * 0.31621623;
    u_xlat2 = u_xlat7.x * u_xlat16_2.x;
...
void main()
{
    ...
    u_xlat8.xyz = u_xlat10_3.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    ...
    u_xlat10_1 = texture2D(_MainTex, u_xlat1.zw);
    u_xlat8.xyz = u_xlat10_4.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
...
void main()
{
    ...
    u_xlat16_8 = texture(_MainTex, vs_TEXCOORD1.xy).x;
    u_xlat3 = u_xlat16_8 * 0.227027029 + u_xlat3;
    u_xlat16_4 = texture(_MainTex, u_xlat1.xy);
    u_xlat16_1 = texture(_MainTex, u_xlat1.zw);
    u_xlat8.xyz = u_xlat16_4.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat8.x = dot(u_xlat0.xyz, u_xlat8.xyz);
    u_xlat8.x = u_xlat8.x + -0.800000012;
    u_xlat8.x = u_xlat8.x * 5.00000048;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat7.x = u_xlat7.x * 0.31621623;
    u_xlat2 = u_xlat7.x * u_xlat10_2.x;
    u_xlat2 = u_xlat10_3.x * 0.227027029 + u_xlat2;
    u_xlat10_4 = texture2D(_MainTex, u_xlat0.xy);
    u_xlat10_0 = texture2D(_MainTex, u_xlat0.zw);
    u_xlat9.xyz = u_xlat10_4.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
...
void main()
{
    ...
    u_xlat7.x = u_xlat7.x * 0.31621623;
    u_xlat2 = u_xlat7.x * u_xlat16_2.x;
    u_xlat2 = u_xlat16_3.x * 0.227027029 + u_xlat2;
    u_xlat16_4 = texture(_MainTex, u_xlat0.xy);
    u_xlat16_0 = texture(_MainTex, u_xlat0.zw);
    u_xlat9.xyz = u_xlat16_4.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat12 = dot(u_xlat8.xyz, u_xlat9.xyz);
...
void main()
{
    ...
    u_xlat7.x = u_xlat7.x * u_xlat7.x;
    u_xlat7.x = u_xlat7.x * u_xlat12;
    u_xlat0.x = u_xlat10_2.x * u_xlat7.x + u_xlat10_0.x;
    ...
    u_xlat2.xzw = u_xlat10_4.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    ...
    u_xlat0.x = u_xlat10_4.x * u_xlat17 + u_xlat0.x;
    u_xlat7.xyz = u_xlat10_3.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat7.x = dot(u_xlat5.xyz, u_xlat7.xyz);
    u_xlat7.x = u_xlat7.x + -0.800000012;
    u_xlat7.x = u_xlat7.x * 5.00000048;
    u_xlat7.x = clamp(u_xlat7.x, 0.0, 1.0);
    ...
    u_xlat0.x = u_xlat10_3.x * u_xlat17 + u_xlat0.x;
    u_xlat6.xyz = u_xlat10_1.yzw * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    ...
    u_xlat0.x = u_xlat10_1.x * u_xlat15 + u_xlat0.x;
...
void main()
{
    ...
    u_xlat0.x = u_xlat10_2.x * u_xlat17 + u_xlat10_0.x;
    u_xlat1.zw = (-u_xlat1.yx);
    u_xlat3 = u_xlat1.xzwy + vs_TEXCOORD0.xyxy;
    u_xlat3 = clamp(u_xlat3, 0.0, 1.0);
    u_xlat1.xy = u_xlat1.xy + vs_TEXCOORD0.xy;
...
void main()
{
    ...
    u_xlat17 = u_xlat7.x * u_xlat12;
    u_xlat7.x = u_xlat12 * u_xlat7.x + 1.0;
    u_xlat0.x = u_xlat16_2.x * u_xlat17 + u_xlat16_0.x;
    u_xlat1.zw = (-u_xlat1.yx);
    u_xlat3 = u_xlat1.xzwy + vs_TEXCOORD0.xyxy;
#ifdef UNITY_ADRENO_ES3
    u_xlat3 = min(max(u_xlat3, 0.0), 1.0);
