...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_0.xyz * vec3(3.55539989, 3.55539989, 0.0) + vec3(-1.77769995, -1.77769995, 1.0);
    u_xlat4 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat4 = 2.0 / u_xlat4;
    u_xlat1.xy = u_xlat0.xy * vec2(u_xlat4);
    u_xlat1.z = u_xlat4 + -1.0;
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat1.xy = u_xlat10_1.xy * vec2(1.0, -1.0);
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat1.xy = u_xlat16_1.xy * vec2(1.0, -1.0);
    u_xlat11 = dot(u_xlat1.xy, u_xlat1.xy);
    u_xlat12.x = inversesqrt(u_xlat11);
#ifdef UNITY_ADRENO_ES3
    u_xlatb11 = !!(u_xlat11!=0.0);
...
void main()
{
    ...
    u_xlat9 = u_xlat1.x * -367.857117 + (-u_xlat9);
    u_xlat9 = u_xlat1.z * 16511.7441 + u_xlat9;
    u_xlat2.z = u_xlat9 * 6.0796734e-05;
    u_xlat2.z = clamp(u_xlat2.z, 0.0, 1.0);
    u_xlat9 = dot(u_xlat1.xy, vec2(4833.03809, 11677.1963));
    u_xlat9 = u_xlat9 * 6.0796734e-05;
    u_xlat2.xy = min(vec2(u_xlat9), vec2(1.0, 1.0));
...
void main()
{
    ...
    u_xlat0.xyz = clamp(u_xlat0.xyz, 0.0, 1.0);
    u_xlat1.xyz = u_xlat0.xyz * u_xlat0.xyz;
    u_xlat9 = u_xlat1.y * 66.0126495;
    u_xlat9 = u_xlat1.x * 66.0126495 + (-u_xlat9);
    u_xlat9 = u_xlat1.z * 16511.7441 + u_xlat9;
    u_xlat2.z = u_xlat9 * 6.0796734e-05;
    u_xlat2.z = clamp(u_xlat2.z, 0.0, 1.0);
    u_xlat9 = dot(u_xlat1.xy, vec2(1855.91467, 14655.8301));
    u_xlat9 = u_xlat9 * 6.0796734e-05;
    u_xlat2.xy = min(vec2(u_xlat9), vec2(1.0, 1.0));
    u_xlat0.xyz = (-u_xlat0.xyz) * u_xlat0.xyz + u_xlat2.xyz;
    u_xlat0.xyz = _Params.xxx * u_xlat0.xyz + u_xlat1.xyz;
