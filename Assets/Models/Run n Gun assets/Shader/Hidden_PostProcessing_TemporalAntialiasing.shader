...
void main()
{
    ...
    u_xlat14.x = dot(u_xlat16_0.xy, u_xlat16_0.xy);
    ...
    u_xlat5 = u_xlat16_2 + u_xlat16_3;
    u_xlat6 = u_xlat16_4 + u_xlat16_4;
    u_xlat5 = u_xlat5 * vec4(4.0, 4.0, 4.0, 4.0) + (-u_xlat6);
    u_xlat6 = (-u_xlat5) * vec4(0.166666999, 0.166666999, 0.166666999, 0.166666999) + u_xlat16_4;
    ...
    u_xlat5.xyz = min(u_xlat16_2.xyz, u_xlat16_3.xyz);
    u_xlat2.xyz = max(u_xlat16_2.xyz, u_xlat16_3.xyz);
...
void main()
{
    ...
    u_xlat3 = u_xlat16_0 + u_xlat16_1;
    u_xlat4 = u_xlat16_2 + u_xlat16_2;
    u_xlat3 = u_xlat3 * vec4(4.0, 4.0, 4.0, 4.0) + (-u_xlat4);
    u_xlat4 = (-u_xlat3) * vec4(0.166666999, 0.166666999, 0.166666999, 0.166666999) + u_xlat16_2;
    ...
    u_xlat3.xyz = min(u_xlat16_1.xyz, u_xlat16_0.xyz);
    u_xlat0.xyz = max(u_xlat16_0.xyz, u_xlat16_1.xyz);
    u_xlat16_1.xy = texture(_CameraMotionVectorsTexture, vs_TEXCOORD1.xy).xy;
    u_xlat13 = dot(u_xlat16_1.xy, u_xlat16_1.xy);
