...
//
///////////////////////////////////////////
Shader "SimplestSpritetShader" {
Properties {
_MainTex ("Sprite Texture", 2D) = "white" { }
_Color ("Tint", Color) = (1,1,1,1)
[MaterialToggle] PixelSnap ("Pixel snap", Float) = 0
_FillAmount ("FillAmount", Range(0, 1)) = 1
_ColoredFillAmount ("ColoredFillAmount", Range(0, 1)) = 1
}
SubShader {
 Tags { "CanUseSpriteAtlas" = "true" "IGNOREPROJECTOR" = "true" "PreviewType" = "Plane" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
 Pass {
  Tags { "CanUseSpriteAtlas" = "true" "IGNOREPROJECTOR" = "true" "PreviewType" = "Plane" "QUEUE" = "Transparent" "RenderType" = "Transparent" "SHADOWSUPPORT" = "true" }
  ZWrite Off
  Cull Off
  GpuProgramID 53749
Program "vp" {
...
void main()
{
    ...
    u_xlat0.xy = u_xlat0.xx * _BendOffset.xy;
    u_xlat1 = in_POSITION0.yyyy * hlslcc_mtx4x4unity_ObjectToWorld[1];
    u_xlat1 = hlslcc_mtx4x4unity_ObjectToWorld[0] * in_POSITION0.xxxx + u_xlat1;
    u_xlat1 = hlslcc_mtx4x4unity_ObjectToWorld[2] * in_POSITION0.zzzz + u_xlat1;
    u_xlat2 = u_xlat1 + hlslcc_mtx4x4unity_ObjectToWorld[3];
    u_xlat9 = hlslcc_mtx4x4unity_ObjectToWorld[3].y * in_POSITION0.w + u_xlat1.y;
    u_xlat9 = u_xlat9 + 6.0;
    ...
    vs_COLOR0 = u_xlat1;
    u_xlat0.x = u_xlat9 * -2.0 + 3.0;
    u_xlat3 = u_xlat9 * u_xlat9;
    vs_TEXCOORD3 = (-u_xlat0.x) * u_xlat3 + 1.0;
...
uniform 	float _ColoredFillAmount;
...
void main()
{
    u_xlatb0.xy = greaterThanEqual(vec4(_FillAmount, _ColoredFillAmount, _FillAmount, _FillAmount), vs_TEXCOORD0.xxxx).xy;
    u_xlat0.x = u_xlatb0.x ? float(1.0) : 0.0;
    u_xlat0.y = u_xlatb0.y ? float(1.0) : 0.0;
;
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat1.xyz = u_xlat10_1.xyz * vs_COLOR0.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_2 = u_xlat10_1.w * vs_COLOR0.w;
    u_xlat2.w = u_xlat0.x * u_xlat16_2;
    u_xlat2.xyz = u_xlat0.yyy * u_xlat1.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat0 = (-u_xlat2) + unity_FogColor;
    u_xlat0 = vec4(vs_TEXCOORD3) * u_xlat0 + u_xlat2;
...
;
    ...
    u_xlat1.xyz = u_xlat16_1.xyz * vs_COLOR0.xyz + vec3(-1.0, -1.0, -1.0);
...
void main()
{
    ...
    u_xlat16_1 = (-u_xlat16_1) * 0.400000006 + 1.0;
    u_xlatb0.xy = greaterThanEqual(vec4(_FillAmount, _ColoredFillAmount, _FillAmount, _FillAmount), vs_TEXCOORD0.xxxx).xy;
    u_xlat0.x = u_xlatb0.x ? float(1.0) : 0.0;
    u_xlat0.y = u_xlatb0.y ? float(1.0) : 0.0;
;
    u_xlat10_2 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat2.xyz = u_xlat10_2.xyz * vs_COLOR0.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_5 = u_xlat10_2.w * vs_COLOR0.w;
    u_xlat3.w = u_xlat0.x * u_xlat16_5;
    u_xlat3.xyz = u_xlat0.yyy * u_xlat2.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat0 = vec4(u_xlat16_1) * u_xlat3;
    u_xlat1 = (-u_xlat3) * vec4(u_xlat16_1) + unity_FogColor;
    u_xlat0 = vec4(vs_TEXCOORD3) * u_xlat1 + u_xlat0;
...
;
    ...
    u_xlat2.xyz = u_xlat16_2.xyz * vs_COLOR0.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_5 = u_xlat16_2.w * vs_COLOR0.w;
    u_xlat3.w = u_xlat0.x * u_xlat16_5;
    u_xlat3.xyz = u_xlat0.yyy * u_xlat2.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat0 = vec4(u_xlat16_1) * u_xlat3;
    u_xlat1 = (-u_xlat3) * vec4(u_xlat16_1) + unity_FogColor;
...
;
    ...
    u_xlat16_2 = u_xlat10_1.w * vs_COLOR0.w;
    u_xlat2.w = u_xlat0.x * u_xlat16_2;
    u_xlat0.xyz = u_xlat0.yyy * u_xlat1.xyz + vec3(1.0, 1.0, 1.0);
...
;
    u_xlat10_2 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat2.xyz = u_xlat10_2.xyz * vs_COLOR0.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_4 = u_xlat10_2.w * vs_COLOR0.w;
    u_xlat0.x = u_xlat0.x * u_xlat16_4;
    u_xlat3.xyz = u_xlat0.yyy * u_xlat2.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat3.xyz = u_xlat3.xyz * vec3(u_xlat16_1) + (-unity_FogColor.xyz);
    u_xlat1.w = u_xlat16_1 * u_xlat0.x;
    u_xlat2.x = vs_TEXCOORD2;
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    u_xlat1.xyz = u_xlat2.xxx * u_xlat3.xyz + unity_FogColor.xyz;
    u_xlat2 = (-u_xlat1) + unity_FogColor;
    u_xlat1 = vec4(vs_TEXCOORD3) * u_xlat2 + u_xlat1;
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "FOG_LINEAR" "PIXELSNAP_ON" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "FOG_LINEAR" "LIGHTPROBE_SH" "PIXELSNAP_ON" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "FOG_LINEAR" "PIXELSNAP_ON" "SHADOWS_SCREEN" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "FOG_LINEAR" "LIGHTPROBE_SH" "PIXELSNAP_ON" "SHADOWS_SCREEN" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "FOG_LINEAR" "PIXELSNAP_ON" "VERTEXLIGHT_ON" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "FOG_LINEAR" "LIGHTPROBE_SH" "PIXELSNAP_ON" "VERTEXLIGHT_ON" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "FOG_LINEAR" "PIXELSNAP_ON" "SHADOWS_SCREEN" "VERTEXLIGHT_ON" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "FOG_LINEAR" "LIGHTPROBE_SH" "PIXELSNAP_ON" "SHADOWS_SCREEN" "VERTEXLIGHT_ON" }
"#ifdef VERTEX
#version 100
