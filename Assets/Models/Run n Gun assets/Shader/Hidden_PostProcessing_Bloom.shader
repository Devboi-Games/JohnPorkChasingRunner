...
void main()
{
    ...
    u_xlat3 = u_xlat10_3 * vec4(2.0, 2.0, 2.0, 2.0) + u_xlat10_4;
    ...
    u_xlat10_5 = texture2D(_MainTex, u_xlat4.xy);
    u_xlat10_4 = texture2D(_MainTex, u_xlat4.zw);
    u_xlat3 = u_xlat10_5 * vec4(2.0, 2.0, 2.0, 2.0) + u_xlat3;
    u_xlat0 = u_xlat10_0 * vec4(4.0, 4.0, 4.0, 4.0) + u_xlat3;
    u_xlat0 = u_xlat10_4 * vec4(2.0, 2.0, 2.0, 2.0) + u_xlat0;
    u_xlat10_3 = texture2D(_MainTex, u_xlat2.xy);
    u_xlat10_2 = texture2D(_MainTex, u_xlat2.zw);
    u_xlat0 = u_xlat0 + u_xlat10_3;
    u_xlat0 = u_xlat10_2 * vec4(2.0, 2.0, 2.0, 2.0) + u_xlat0;
    u_xlat0 = u_xlat10_1 + u_xlat0;
    u_xlat10_1 = texture2D(_BloomTex, vs_TEXCOORD1.xy);
    SV_Target0 = u_xlat0 * vec4(0.0625, 0.0625, 0.0625, 0.0625) + u_xlat10_1;
    return;
}
...
void main()
{
    ...
    u_xlat0 = u_xlat16_4 * vec4(2.0, 2.0, 2.0, 2.0) + u_xlat0;
    u_xlat16_3 = texture(_MainTex, u_xlat2.xy);
    u_xlat16_2 = texture(_MainTex, u_xlat2.zw);
    ...
    SV_Target0 = u_xlat0 * vec4(0.0625, 0.0625, 0.0625, 0.0625) + u_xlat16_1;
    return;
}
...
void main()
{
    ...
    u_xlat10_1 = texture2D(_BloomTex, vs_TEXCOORD1.xy);
    SV_Target0 = u_xlat0 * vec4(0.25, 0.25, 0.25, 0.25) + u_xlat10_1;
    return;
}
...
void main()
{
    ...
    u_xlat16_1 = texture(_BloomTex, vs_TEXCOORD1.xy);
    SV_Target0 = u_xlat0 * vec4(0.25, 0.25, 0.25, 0.25) + u_xlat16_1;
    return;
}
...
void main()
{
    ...
    u_xlat0.xyz = min(u_xlat10_0.xyz, vec3(65504.0, 65504.0, 65504.0));
...
void main()
{
    ...
    u_xlat0.xyz = min(u_xlat16_0.xyz, vec3(65504.0, 65504.0, 65504.0));
...
void main()
{
    ...
    u_xlat3.xyz = u_xlat10_3.xyz * vec3(2.0, 2.0, 2.0) + u_xlat10_4.xyz;
    u_xlat4.xy = (-u_xlat1.zy) * u_xlat2.zx + vs_TEXCOORD0.xy;
    u_xlat4.xy = clamp(u_xlat4.xy, 0.0, 1.0);
    u_xlat4.xy = u_xlat4.xy * vec2(_RenderViewportScaleFactor);
    ...
    u_xlat3.xyz = u_xlat10_5.xyz * vec3(2.0, 2.0, 2.0) + u_xlat3.xyz;
    u_xlat0.xyz = u_xlat10_0.xyz * vec3(4.0, 4.0, 4.0) + u_xlat3.xyz;
    u_xlat0.xyz = u_xlat10_4.xyz * vec3(2.0, 2.0, 2.0) + u_xlat0.xyz;
    ...
    u_xlat0.xyz = u_xlat10_2.xyz * vec3(2.0, 2.0, 2.0) + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat3.xyz = u_xlat16_3.xyz * vec3(2.0, 2.0, 2.0) + u_xlat16_4.xyz;
    u_xlat4.xy = (-u_xlat1.zy) * u_xlat2.zx + vs_TEXCOORD0.xy;
#ifdef UNITY_ADRENO_ES3
    u_xlat4.xy = min(max(u_xlat4.xy, 0.0), 1.0);
#else
    ...
    u_xlat3.xyz = u_xlat16_5.xyz * vec3(2.0, 2.0, 2.0) + u_xlat3.xyz;
    u_xlat0.xyz = u_xlat16_0.xyz * vec3(4.0, 4.0, 4.0) + u_xlat3.xyz;
    u_xlat0.xyz = u_xlat16_4.xyz * vec3(2.0, 2.0, 2.0) + u_xlat0.xyz;
    ...
    u_xlat0.xyz = u_xlat16_2.xyz * vec3(2.0, 2.0, 2.0) + u_xlat0.xyz;
